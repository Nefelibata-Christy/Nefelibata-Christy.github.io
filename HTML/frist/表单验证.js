    ...
    submitElt.onclick=function () {
            if(!(useridElt.value=="")&&useridRetVal&&!(usernameElt.value=="")&&usernameRetVal&&!(passwordElt.value=="")&&passwordRetVal&&!(confirmPwdElt.value=="")&&passwordElt.value===confirmPwdElt.value){
